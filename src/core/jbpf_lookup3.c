...
#else /* make valgrind and ASAN happy */
...
driver3()
{
    ...
    uint32_t len;
    uint8_t q[] = "Now it is ideal for people to come to the aid of their country/region...";
    uint32_t h;
    uint8_t qq[] = "xNow it is ideal for people to come to the aid of their country/region...";
    uint32_t i;
    uint8_t qqq[] = "xxNow it is ideal for people to come to the aid of their country/region...";
    uint32_t j;
    uint8_t qqqq[] = "xxxNow it is ideal for people to come to the aid of their country/region...";
    uint32_t ref, x, y;
    uint8_t* p;
