...
# This test loads a codeletset, invokes the report_stats hook multiple times,
# verifies the output data generated by the codelet, and then unloads the codeletset.
