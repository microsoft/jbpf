...
- [jbpf-protobuf](https://github.com/microsoft/jbpf-protobuf): *jbpf* extension, used in *jrt-controller*, that demonstrates how to utilize protobuf serialization for sending and receiving data from codelets loaded in jbpf applications.
