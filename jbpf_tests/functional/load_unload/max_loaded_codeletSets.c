/*
 * The purpose of this test is to ensure we can load the maximum number of codeletSets
 *
 * This test does the following:
 * 1. It loads "JBPF_MAX_LOADED_CODELETSETS" codeletSets, with each codeletSet having one codelet.
 * 2. The code asserts that all the codeletSets are loaded successfully.
