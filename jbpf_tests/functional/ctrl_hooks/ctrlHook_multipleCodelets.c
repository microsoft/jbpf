 ...
 * 1. It create a codeletset with 2 codelets.
 * 2. It asserts that the return code from the jbpf_codeletset_load call is JBPF_CODELET_LOAD_FAIL.
 * 3. It tries to unload the codeletSet, and asserts that this returns JBPF_CODELET_UNLOAD_FAIL.
 */
