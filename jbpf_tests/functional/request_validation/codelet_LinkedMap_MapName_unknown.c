/*
 * The purpose of this test is to ensure if we can configure a linked map with an unknown "map_name", the load request
 * will fail.
 *
 ...
 * 4. Codelet 2 is configured with 1 linked map.  The "map_name" is set to "unknown_map".  This should cause the load to
 * fail.
...
main(int argc, char** argv)
{
    ...
    strcpy(codeletset_req_c1.codelet_descriptor[1].linked_maps[0].map_name, "unknown_map");
