/*
 * The purpose of this test is to ensure that if a codeletSet id is set too long, it is captured during validation
 * checks.
 *
 * This test does the following:
 * 1. It creates the config for a codeletset with a single codelet (C1).
 * 2. It explicitly sets the codeletSet Id with a string which is too long.
...
main(int argc, char** argv)
{
    ...
    // The name of the codeletset
    // Fill it with non-zero values (e.g., 'A')
