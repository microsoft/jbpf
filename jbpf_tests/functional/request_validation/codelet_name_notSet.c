/*
 * The purpose of this test is to ensure that if a codelet name is not set, it is captured during validation checks.
 *
 * This test does the following:
 * 1. It creates the config for a codeletset with a single codelet (C1).
 * 2. It explicitly does not set codelet_descriptor[0].codelet.
...
main(int argc, char** argv)
{
    ...
    // DO NOT SET strcpy(codeletset_req_c1.codelet_descriptor[0].codelet_name, "simple_output");
