/*
 * The purpose of this test is to ensure if we can configure a linked map to use an output map, the load request
 * will fail.
 *
 ...
 * 4. Codelet 1 is configured with 1 linked map.  The "linked_map_name" is set to "output_map".  This should cause the
 * load to fail.
...
main(int argc, char** argv)
{
    ...
    strcpy(codeletset_req_c1.codelet_descriptor[0].linked_maps[0].map_name, "shared_map");
