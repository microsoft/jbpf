/*
 * The purpose of this test is to ensure that if a codelet path is not set, it is captured during validation checks.
 *
 * This test does the following:
 * 1. It creates the config for a codeletset with a single codelet (C1).
 * 2. It explicitly does not set codelet_descriptor[0].codelet_path
...
main(int argc, char** argv)
{
    ...
    // The codelet path is set to an empty string
    codeletset_req_c1.codelet_descriptor[0].codelet_path[0] = '\0';
