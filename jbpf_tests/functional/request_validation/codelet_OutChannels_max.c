/*
 * The purpose of this test is to ensure we can configure the maximum number of output channels for a codelet.
 *
 * This test does the following:
 * 1. It creates the config for a codeletset with a single codelet (C1).
 * 2. It populates the JBPF_MAX_IO_CHANNEL number of out_io_channel, and num_out_io_channel to "JBPF_MAX_IO_CHANNEL".
