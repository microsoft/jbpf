/*
 * The purpose of this test is to ensure if we can configure a linked map to use an input map, the load request
 * will fail.
 *
 ...
 * 4. Codelet 2 is configured with 1 linked map.  The "linked_map_name" is set to "input_map".  This should cause the
 * load to fail.
