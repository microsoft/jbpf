/*
 * The purpose of this test is to ensure that if too many codelets are configured, it is captured during validation
 * checks.
 *
 * This test does the following:
 * 1. It pupulates a codeletset with JBPF_MAX_CODELETS_IN_CODELETSET codelets.
 * 2. It sets num_codelet_descriptors to "JBPF_MAX_CODELETS_IN_CODELETSET + 1" i.e. configuring too many.
...
main(int argc, char** argv)
{
    ...
    codeletset_req_c1.num_codelet_descriptors = JBPF_MAX_CODELETS_IN_CODELETSET + 1;
