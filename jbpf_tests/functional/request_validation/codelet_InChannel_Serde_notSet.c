/*
 * The purpose of this test is to ensure we can configure an "in" channel but dont set Serde, it fails validation
 *
 * This test does the following:
 * 1. It creates the config for a codeletset with a single codelet with a single input channel.
 * 2. It populates the Serde of the in_io_channel with a string which is zero length.
...
main(int argc, char** argv)
{
    ...
    codeletset_req_c1.codelet_descriptor[0].in_io_channel[0].serde.file_path[0] = '\0';
