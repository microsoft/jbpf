/*
 * The purpose of this test is to ensure that if we can configure a linked map to be an output map, the load request
 * will fail.
 *
 ...
 * 4. Codelet 2 is configured with 1 linked map.  The "map_name" is set to "output_map".  This should cause the
 * load to fail.
...
main(int argc, char** argv)
{
    ...
    strcpy(codeletset_req_c1.codelet_descriptor[1].linked_maps[0].linked_codelet_name, "simple_input_shared");
