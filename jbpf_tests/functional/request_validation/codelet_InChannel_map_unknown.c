/*
 * The purpose of this test is to ensure if, for an "input" channel, a map is configured which is not present in the
 ...
 * 2. The code set to input map to another map which is unknown.
...
main(int argc, char** argv)
{
    ...
    // set an unknown map.
    strcpy(codeletset_req_c1.codelet_descriptor[0].in_io_channel[0].name, "unknown_map");
