/*
 * The purpose of this test is to ensure that if a hook is set to the maximum length, it is handled correctly.
 *
 * This test does the following:
 * 1. It creates the config for a codeletset with a single codelet (C1).
 * 2. It creates a single codelet to be configured to use the hook with the maximum length.
 * 3. It asserts that the return code from the jbpf_codeletset_load call is JBPF_CODELET_PARAM_SUCCESS).
 * 4. It calls the hook NUM_ITERATIONS times, and assert that the output is correct.
 * 5. It unloads th ecodeletset and assert that the return code from the jbpf_codeletset_unload call is
...
main(int argc, char** argv)
{
    ...
    snprintf(
        codeletset_req_c1.codelet_descriptor[0].hook_name,
        JBPF_HOOK_NAME_LEN,
        "test0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789"
    ...
    for (int i = 0; i < NUM_ITERATIONS; i++) {
        hook_test0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef0123456789a(
            &p, 0);
        p.counter_a++;
    }
